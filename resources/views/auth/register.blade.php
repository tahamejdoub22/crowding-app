<x-auth-layout title="Create Account - CrowdFund Platform">
    ...
    <div class="glass-effect rounded-3xl p-8 shadow-2xl" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="text-center mb-8">
            ...
            <h2 class="text-3xl font-display font-bold text-black mb-2">Join CrowdFund</h2>
            <p class="text-gray-700">Create your account and start your journey</p>
        </div>
        ...
        <div class="space-y-6">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <!-- Name -->
                    <div>
                        <label for="name" class="block text-sm font-semibold text-black mb-3">
                            Full Name
                        </label>
                        <input 
                            id="name" 
                    ...
                    <!-- Confirm Password -->
                    <div>
                        <label for="password_confirmation" class="block text-sm font-semibold text-black mb-3">
                            Confirm Password
                        </label>
                        <input 
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <label class="relative flex cursor-pointer">
                                <input 
                                    ...
                                    checked
                                />
                                <div class="flex-1 p-4 border-2 border-gray-300 bg-white rounded-xl peer-checked:border-primary-400 peer-checked:bg-primary-50 transition-all duration-300">
                                    <div class="text-center">
                                        ...
                                        <div class="text-sm font-medium text-black">Create Projects</div>
                                        <div class="text-xs text-gray-600 mt-1">Launch and manage campaigns</div>
                                    </div>
                                </div>
                            </label>
                            ...
                            <label class="relative flex cursor-pointer">
                                ...
                                <div class="flex-1 p-4 border-2 border-gray-300 bg-white rounded-xl peer-checked:border-primary-400 peer-checked:bg-primary-50 transition-all duration-300">
                                    <div class="text-center">
                                        ...
                                        <div class="text-sm font-medium text-black">Back Projects</div>
                                        <div class="text-xs text-gray-600 mt-1">Support amazing ideas</div>
                                    </div>
                                </div>
                            </label>
                        </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            <label for="terms" class="text-sm text-gray-700">
                                I agree to the 
                                <a href="#" class="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">Terms of Service</a> 
                                and 
                                <a href="#" class="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">Privacy Policy</a>
                            </label>
                        </div>
                    </div>
                ...
                <div class="text-center mt-8">
                    <p class="text-gray-600">
                        ...
                        <a href="{{ route('login') }}" class="font-semibold text-primary-600 hover:text-primary-700 transition-colors duration-200 underline underline-offset-2">
                            Sign in instead
                        </a>
                    </p>
                </div>
