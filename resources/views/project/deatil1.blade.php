...
<div class="page-wrapper">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-6">
                        ...
                        <div class="col-sm-6">
                            <a href="#addreward" class="btn btn-success" data-toggle="modal"><i class="material-icons"> <span>Add New reward</span></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-8 col-lg-5">
                        <div class="project-details__tab-box tabs-box">
                            <ul class="tab-buttons clearfix list-unstyled clearfix">
                                ...
                                <li data-tab="#reviews" class="tab-btn"><span>Reviews ({{ count($projects->comment) }})</span></li>
                            </ul>
                            <div class="tabs-content">
                                ...
                                <div class="tab " id="reviews">
                                    ...
                                    <form action="{{ url('/deatil1/' . $projects->id) }}" method="post"
                                        ...
                                        {{ csrf_field() }}                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div
                                                    ...
                                                    <textarea name="text"
                                                        placeholder="Write a update"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="project-details__review-form-input-box">
                                                    ...
                                                    <input type="hidden" name="user_id" value="{{ $projects->user->id }}" />
        ...
        <div id="addreward" class="modal fade">
