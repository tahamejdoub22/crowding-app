                    ...
                    <div class="main-menu-three__wrapper">
                        <div class="main-menu-three__left">
                            <div class="main-menu-three__logo">
                                <a href="#"><img src="{{asset('resp/images/resources/logo-1.png')}}"style="max-width: 50%;
                                    max-height: 50%;" alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="recommended-one__single">
                            <div class="recommended-one__img-box">
                                ...
                                <div class="recommended-one__content">
                                    ...
                                    <h3 class="recommended-one__title"><a href="{{ url('/detail/' . $item->id) }}">{{ $item->project_name }}</a></h3>
                                    ...
                                    <div class="project-one__goals">
                                        <p class="project-one__goals-one"><span>{{ $item->pledged }}</span>
                                            <br>{{ $item->goal }}</p>
